...
export default function Drill() {
    ...
    return (
        <div className="size-full bg-white overflow-auto flex flex-col pt-10 pb-20 min-h-screen">
                    ...
                    <div className="space-y-8 flex-1">
                        ...
                        <div className="bg-gray-50 border border-gray-100 p-6 rounded-lg text-center">
                            ...
                            <div className="flex items-center justify-center gap-8">
                                <button onClick={() => setDistance(d => Math.max(3, d - 1))}
                                        className="size-12 rounded-full border border-gray-200 flex items-center justify-center text-2xl active:bg-gray-200 transition-colors">-
                                </button>
                                <div className="w-24 text-center">
                                    <span className="text-4xl font-light">{distance}</span><span
                                    className="text-xl text-gray-400 ml-1">m</span>
                                </div>
                        ...
                        <div className="bg-gray-50 border border-gray-100 p-6 rounded-lg text-center">
                            ...
                            <div className="flex items-center justify-center gap-8">
                                <button onClick={() => setDiscsCount(c => Math.max(1, c - 1))}
                                        className="size-12 rounded-full border border-gray-200 flex items-center justify-center text-2xl active:bg-gray-200 transition-colors">-
                                </button>
                                <div className="w-24 text-center">
                                    <span className="text-4xl font-light">{discsCount}</span><span
                                    className="text-xl text-gray-400 ml-1">ks</span>
                                </div>
                                <button onClick={() => setDiscsCount(c => Math.min(30, c + 1))}
                                        className="size-12 rounded-full border border-gray-200 flex items-center justify-center text-2xl active:bg-gray-200 transition-colors">+
                                </button>
                            </div>
                        </div>
                        ...
                        <div className="bg-gray-50 border border-gray-100 p-6 rounded-lg text-center">
                            ...
                            <div className="flex items-center justify-center gap-8">
                                <button onClick={() => setTargetPutts(t => Math.max(10, t - 10))}
                                        className="size-12 rounded-full border border-gray-200 flex items-center justify-center text-2xl active:bg-gray-200 transition-colors">-
                                </button>
                                <div className="w-24 text-center">
                                    <span className="text-4xl font-light">{targetPutts}</span>
                                </div>
                                <button onClick={() => setTargetPutts(t => t + 10)}
                                        className="size-12 rounded-full border border-gray-200 flex items-center justify-center text-2xl active:bg-gray-200 transition-colors">+
                                </button>
                            </div>
                        </div>
                ...
                <div className="flex-1 flex flex-col px-6">
                    <div className="text-center py-6 border-b border-gray-100 flex justify-between items-center">
                        ...
                        <div className="text-right">
                            <div className="text-3xl font-light text-black">{attempts} <span
                                className="text-lg text-gray-400">/ {targetPutts}</span></div>
                        </div>
                    </div>
                    ...
                    <div className="flex-1 flex flex-col items-center justify-center py-8 w-full">
                        <div className="flex gap-4 w-full mb-12">
                            ...
                            <div
                                className="flex-1 border border-gray-200 bg-gray-50 rounded-lg py-6 text-center flex flex-col items-center justify-center relative overflow-hidden">
            ...
            {phase === 'finished' && (
                <div className="flex-1 flex flex-col items-center justify-center px-6 text-center">
                    ...
                    <div
                        ...
                        <p className="text-5xl font-light mb-2">{successRate}<span
                            className="text-3xl text-gray-400">%</span></p>
